...
class CalculatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calculator" do
    assert_difference('Calculator.count') do
      post calculators_url, params: { calculator: { formula: @calculator.formula, title: @calculator.title, user_id: @calculator.user_id } }
    end
  ...
  test "should update calculator" do
    patch calculator_url(@calculator), params: { calculator: { formula: @calculator.formula, title: @calculator.title, user_id: @calculator.user_id } }
